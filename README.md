...
### Installation
    ...
    composer require hpez/laravel-workflow
...
'providers' => [
    ...
    Hpez\LaravelWorkflow\WorkflowServiceProvider::class,
...
<?php
    ...
    'Workflow' => Hpez\LaravelWorkflow\Facades\WorkflowFacade::class,
```
...
```
    php artisan vendor:publish --provider="Hpez\LaravelWorkflow\WorkflowServiceProvider"
```
...
use Hpez\LaravelWorkflow\Traits\WorkflowTrait;
...
```php
    Hpez\LaravelWorkflow\Events\Guard
    Hpez\LaravelWorkflow\Events\Leave
    Hpez\LaravelWorkflow\Events\Transition
    Hpez\LaravelWorkflow\Events\Enter
    Hpez\LaravelWorkflow\Events\Entered
```
...
use Hpez\LaravelWorkflow\Events\GuardEvent;
...
class BlogPostWorkflowSubscriber
{
    ...
    {
        $events->listen(
            'Hpez\LaravelWorkflow\Events\GuardEvent',
            'App\Listeners\BlogPostWorkflowSubscriber@onGuard'
        );

        $events->listen(
            'Hpez\LaravelWorkflow\Events\LeaveEvent',
            'App\Listeners\BlogPostWorkflowSubscriber@onLeave'
        );

        $events->listen(
            'Hpez\LaravelWorkflow\Events\TransitionEvent',
            'App\Listeners\BlogPostWorkflowSubscriber@onTransition'
        );

        $events->listen(
            'Hpez\LaravelWorkflow\Events\EnterEvent',
            'App\Listeners\BlogPostWorkflowSubscriber@onEnter'
        );

        $events->listen(
            'Hpez\LaravelWorkflow\Events\EnteredEvent',
